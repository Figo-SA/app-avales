...
export default function SecretariaDeportistasScreen() {
      ...
      <CrudList
        ...
        renderItem={(deportista) => (
          <DeportistaCard
            ...
            onPress={() =>
              router.push({
                pathname: "/(protected)/(secretaria)/deportista/[id]",
        ...
        onAdd={() =>
          router.push("/(protected)/(secretaria)/deportista/create" as any)
        }
